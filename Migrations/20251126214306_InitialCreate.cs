            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MediaChannel = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductionStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ScheduledRunDateStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ScheduledRunDateEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adverts_Campaigns_CampaignId",
